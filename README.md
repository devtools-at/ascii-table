...
Ascii Table - Free online developer tool

## Online Tool

Use this tool online at **[DevTools.at](https://devtools.at/tools/ascii-table)** - Free, fast, and no registration required!
...
```bash
npm install @devtools-at/ascii-table
```

### Usage

```javascript
import { process, encode, decode } from '@devtools-at/ascii-table';
...
**[https://devtools.at/tools/ascii-table](https://devtools.at/tools/ascii-table)**
...
- [npm Package](https://www.npmjs.com/package/@devtools-at/ascii-table)
